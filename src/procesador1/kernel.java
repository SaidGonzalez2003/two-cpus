...
public class kernel {
    ...
    public static int cicloDeComputoDEBUG() {
         ...
         */
        int salida;
        System.out.println("-----------Procesador 1------------");
    ...
    public static void principal() {
        ...
        do {
            salida = procesador1.kernel.cicloDeComputoDEBUG();
        } while (salida == 0);
    }

    /**
     * Esta es la función principal del código donde se controla el llamado a
     * las demás funciones del microprocesador.
     *
