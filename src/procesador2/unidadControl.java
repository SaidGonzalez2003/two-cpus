...
public class unidadControl {
     ...
     */
     public void instructionFetch(){         
         procesador2.kernel.UC.registroInstruccion=integrador.principal.MEMORIA.lectura(this.contadorPrograma);
         procesador2.kernel.UC.registroInstruccion=procesador2.kernel.UC.registroInstruccion.replace("-", "");
    }
     ...
     public void dataFetch(){
         ...
         procesador2.kernel.ALU.registroEntrada1=integrador.principal.MEMORIA.lectura(tmp);
         procesador2.kernel.ALU.registroEntrada1=procesador2.kernel.ALU.registroEntrada1.replace("-", "");
         procesador2.kernel.ALU.banderas[1]=1;
         tmp= Integer.parseInt(this.decodificarDato2,2);
         procesador2.kernel.ALU.registroEntrada2=integrador.principal.MEMORIA.lectura(tmp);
         procesador2.kernel.ALU.registroEntrada2=procesador2.kernel.ALU.registroEntrada2.replace("-", "");
         procesador2.kernel.ALU.banderas[2]=1;
         
        tmp = Integer.parseInt(this.decodificarDato3, 2);
        procesador2.kernel.ALU.registroEntrada3 = integrador.principal.MEMORIA.lectura(tmp);
        procesador2.kernel.ALU.registroEntrada3 = procesador2.kernel.ALU.registroEntrada3.replace("-", "");
        procesador2.kernel.ALU.banderas[2] = 1;
     }
    ...
    public void decode(){
        ...
        procesador2.kernel.ALU.operacion = Integer.parseInt(this.decodificarInstruccion, 2);
        procesador2.kernel.ALU.banderas[0]=1;
    }
    ...
    public int execute(){
        int salida;
        salida=procesador2.kernel.ALU.ejecutarInstruccion();
        return salida;
    }
    ...
    public void store(){
        ...
        if((procesador2.kernel.ALU.operacion!=15)&&(procesador2.kernel.ALU.operacion!=0)){
            tmp = procesador2.kernel.ALU.acumulador;
            direccion = Integer.parseInt(procesador2.kernel.UC.decodificarResultado, 2);
            ...
            procesador2.kernel.UC.contadorPrograma++;
        }
    }
